            ...
            <div className='container-fluid mt-4'>
                <div className='row d-flex justify-content-start search '>
                    ...
                    <div className="col-5 d-flex justify-content-end">
                        <Link to="/fav" className='text-dark'><BsSuitHeart style={{ width: "40px", height: "40px", marginRight: "20px" }} />{counter.length > 0 ? <span class="count"> {counter.length}</span> : ""}</Link>
                        <Link to="/basket" className='text-dark'> <HiOutlineShoppingBag style={{ width: "40px", height: "40px" }} />{counterproduct.length > 0 ? <span class="countcart"> {counterproduct.length}</span> : ""}</Link>
                    </div>
                </div>
            </div>
            {/*List Ctegory*/}
